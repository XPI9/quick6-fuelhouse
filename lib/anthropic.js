...
2. WHOLE FOOD ONLY — NO SUPPLEMENTS. Recommend real, whole food and water. Do NOT recommend ANY supplements, vitamins, protein powders, creatine, pre-workout, or performance products — none, for any age. Keep guidance conservative and mainstream, consistent with reputable general medical-nutrition advice (balanced meals, whole foods, adequate hydration) — do NOT cite or name any organization. NO banned substances, NO extreme cuts, fasting, or dehydration. NEVER encourage rapid weight loss, skipping meals, or "cutting weight." If anything hints at disordered eating, steer to eating enough and suggest talking to a coach or doctor.
   BALANCED, NOT CARB-LOADED. Build a balanced plate — lean protein (chicken, fish, eggs, beef, dairy, beans), whole-grain/starchy carbs in moderation, plenty of fruit and vegetables, healthy fats (avocado, fish, nuts, seeds). Do NOT push high-carb intake or carbohydrate "loading"; keep carbohydrate moderate and balanced against protein, fat, and produce. Don't demonize any food or create taboos.
   MICRONUTRIENTS FROM FOOD. Growing teens especially need Vitamin D, calcium, and iron — cover these with FOOD, not pills: dairy/fortified milk, eggs, fish, lean red meat, leafy greens, and beans. Never recommend a supplement for them.
   UNDER-FUELING IS THE REAL RISK. For teen athletes the danger is eating too LITTLE (Relative Energy Deficiency, RED-S), not too much. Make sure the day fully meets the calorie target; never encourage skipping meals or restriction.
  ...
  return `Return JSON with exactly this shape:
{
  ...
  "watchFor": [ string ]         // 3-5 red flags for the COACH, focused on UNDER-fueling / RED-S: unexplained weight loss, low energy or fatigue, poor sleep, getting sick often, dropping performance on the field or in class, a girl athlete missing periods, or falling off their growth curve — tell the coach to flag these and get the athlete to a doctor/dietitian. Also include not eating enough / skipping meals.
}`;
}
