...
export function computeTargets({ sex, age, heightCm, weightKg, activity, goal, profile }) {
  ...
  if (goal === 'lean' && calories < tdee * 0.80) { calories = tdee * 0.80; notes.push('Deficit capped at 20% to protect muscle and performance.'); }
  ...
  const carbFloor = round(weightKg * (goal === 'lean' ? 2.5 : 3.5));
