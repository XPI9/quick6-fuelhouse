...
// What the athlete can train with — drives the training program (many HS kids
// have no weights at home, so bodyweight has to be a first-class option).
export const EQUIPMENT = [
  { key: 'gym', label: 'Full weight room' },
  { key: 'basic', label: 'Dumbbells / bands' },
  { key: 'home', label: 'Home — bodyweight only' },
];
